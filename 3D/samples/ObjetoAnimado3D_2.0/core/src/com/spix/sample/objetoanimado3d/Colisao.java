...
public class Colisao extends ApplicationAdapter implements AnimationController.AnimationListener{
    ...
    // Collisão / Bounding Box
    private BoundingBox object1BoundingBox;
    private BoundingBox object2BoundingBox;
	...
	public void create() {
        ...
        // Inicialize os bounding boxes dos objetos 3D
        object1BoundingBox = new BoundingBox();
        object2BoundingBox = new BoundingBox();

        // DImensões de Colisão
        object1BoundingBox.set(new Vector3(-0.5f, 0, -0.5f), new Vector3(0.5f, 1.8f, 0.5f));
        object2BoundingBox.set(new Vector3(-0.5f, 0, -0.5f), new Vector3(0.5f, 1.8f, 0.5f));
